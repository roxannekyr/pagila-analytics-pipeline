...
table_id = 'stg_payment' # table name: stg_customer, stg_city etc.
...
# Writting the dataframe to the table (overwriting if it exists, create if it doesn't)
...
get_ipython().system("python -m jupyter nbconvert stg_payment.ipynb --to python --output-dir='../'")
