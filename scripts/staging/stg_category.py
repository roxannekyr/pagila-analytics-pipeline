...
table_id = 'stg_category' # table name: stg_customer, stg_city etc.
...
# Defining SQL query here
query = """
with base as (
  select *
  from `project-401f4646-3663-4125-aaa.pagila_productionpublic.category` --Your table path
  )
