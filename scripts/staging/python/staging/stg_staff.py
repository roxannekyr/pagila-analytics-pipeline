...
table_id = 'stg_staff' # table name: stg_customer, stg_city etc.
...
if table_exists(client, full_table_id):
    # If the table exists, overwritting it
...
get_ipython().system("python -m jupyter nbconvert stg_staff.ipynb --to python --output-dir='../'")
