...
table_id = 'stg_film_category' # table name: stg_customer, stg_city etc.
...
get_ipython().system("python -m jupyter nbconvert stg_film_category.ipynb --to python --output-dir='../'")
