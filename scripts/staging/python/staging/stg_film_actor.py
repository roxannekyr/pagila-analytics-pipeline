...
table_id = 'stg_film_actor' # table name: stg_customer, stg_city etc.
...
# Writtinh the dataframe to the table (overwriting if it exists, creating if it doesn't)
...
get_ipython().system("python -m jupyter nbconvert stg_film_actor.ipynb --to python --output-dir='../'")
