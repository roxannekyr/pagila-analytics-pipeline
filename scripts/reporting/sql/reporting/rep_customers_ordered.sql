...
, cte_lifetime_revenue as (
    ...
    group by cte_customers.customer_id, customer_name
)
...
order by cte_lifetime_revenue.customer_id;

/*
--------------------------------------------------------------------------------------------------------------------------------------------------------------
PS: One row per customer showing lifetime metrics, segment, and recency in order to be used as a dimension table related to rep_rental_details via customer_id.
--------------------------------------------------------------------------------------------------------------------------------------------------------------
*/
